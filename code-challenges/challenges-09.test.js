...
// console.log(addPurchases([{item: 'switch', purchasePrice: 399}, {item: 'toothpaste', purchasePrice: 2}]))
// .toStrictEqual(401);
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  return arr.reduce((length) => {return length +=  1;});
...
// // .toStrictEqual([ 'Luke Skywalker', 'C-3PO', 'R2-D2', 'Darth Vader', 'Leia Organa' ]);
/* ------------------------------------------------------------------------------------------------
CHALLENGE 6
...
const reversedString = (str) => {
  ...
  return arrStr.reduce((reverseAcc, element) => {return element + reverseAcc;}, '');
};
